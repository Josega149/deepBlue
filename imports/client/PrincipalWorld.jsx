...
import lectorSensores2 from './lectorSensores2.js';
  ...
  dibujar(){
    console.log("dibujando mapa");
      ...
      for(var w=0;w<cuantosLotesDeObjetos;w++){
        ...
        var msg = lectorSensores2.traerProximoLote();
        console.log(msg);
                                        ...
                                        <div className="data-content">
                                            <div className="row m-t-sm">
                                                ...
                                                <div className="col-sm-4">
                                                    ...
                                                    <div className="font-bold text-navy">85%
                                                        <i className="fa fa-bolt"></i>
                                                    </div>
                                                </div>
                                                <div className="col-sm-4">
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-9">
                                                            <h1 id="sal" className="no-margins">3%</h1>halinidad
                                                        </div>
                                                    </div>
                                                    <div className="font-bold text-navy">90%
                                                        <i className="fa fa-bolt"></i>
                                                    </div>
                                                </div>
                                            </div>
