...
import estadisticasCol from '../imports/client/estadisticasCol.jsx';
import estadisticasMun from '../imports/client/estadisticasMun.jsx';
...
Meteor.startup(() => {
  ...
  <Router history={browserHistory}>
    <Route path='/' component={App}>
      ...
      <Route path= 'estadisticasCol' component={estadisticasCol}/>
      <Route path= 'estadisticasMun' component={estadisticasMun}/>
    </Route>
